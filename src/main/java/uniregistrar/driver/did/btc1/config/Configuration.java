package uniregistrar.driver.did.btc1.config;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import uniregistrar.driver.did.btc1.DidBtc1Driver;
...
public class Configuration {
    ...
    public static Map<String, Object> getPropertiesFromEnvironment() {
        ...
        try {
            ...
            String env_bitcoinConnections = System.getenv("uniregistrar_driver_did_btc1_bitcoinConnections");
            String env_bitcoinConnectionsUrls = System.getenv("uniregistrar_driver_did_btc1_bitcoinConnectionsUrls");
            String env_bitcoinConnectionsCerts = System.getenv("uniregistrar_driver_did_btc1_bitcoinConnectionsCerts");
            String env_genesisHashes = System.getenv("uniregistrar_driver_did_btc1_genesisHashes");
            String env_ipfs = System.getenv("uniregistrar_driver_did_btc1_ipfs");
