...
public class TransitionInit {
    ...
    public static CreateState transitionToFinished(JobRegistry jobRegistry, Job job, BitcoinConnection bitcoinConnection, String btc1Did, Map<String, Object> didDocumentMetadata) {
