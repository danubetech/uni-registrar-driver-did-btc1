...
import uniregistrar.driver.did.btc1.appendix.Bech32mEncoding;
...
public class DidBtc1IdentifierEncoding {
    ...
    public static DID didBtc1IdentifierEncoding(String idType, Integer version, Object networkValue, byte[] genesisBytes) throws RegistrationException {
    ...
    // See https://dcdpr.github.io/did-btc1/#didbtc1-identifier-encoding
    public static DID didBtc1IdentifierEncoding(IdentifierComponents identifierComponents) throws RegistrationException {
