package uniregistrar.driver.did.btc1.syntax;
...
import uniregistrar.driver.did.btc1.appendix.Bech32mDecoding;
import uniregistrar.driver.did.btc1.syntax.records.IdentifierComponents;
...
public class DidBtc1IdentifierDecoding {
    ...
    public static IdentifierComponents didBtc1IdentifierDecoding(DID identifier) throws RegistrationException {
        ...
        if (! "btc1".equals(components[1])) throw new RegistrationException(RegistrationException.ERROR_METHOD_NOT_SUPPORTED, "Unsupported DID method (must be 'btc1'): " + identifier.getDidString());
